...
path_calculix = "D:\\FreeCAD\\bin\\ccx"  # path to the CalculiX solver
...
domain_material[elset_name] = ["*ELASTIC \n114000e-6,  0.3",  # material definition after CalculiX *MATERIAL card, use \n for line break
                               "*ELASTIC \n114000,  0.3"]  # next string for the next state of switch_elm
...
filter_list = [["simple", 4]]  # [[filter type, range, domains or nothing for all domains], [next filter type, range, "domain1", "domain2"], ...]
                            # filter types:
...
optimization_base = "failure_index"  # "stiffness" - maximization of stiffness (minimization of compliance), reference_points must be set to "integration points"
...
mass_addition_ratio = 0.03  # mass to be added in each iteration
mass_removal_ratio = 0.06  # mass to be removed in each iteration
